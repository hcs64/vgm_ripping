...
all: cpk_unpack utf_view csb_extract usm_deinterleave
...
clean:
	rm -f csb_extract cpk_unpack usm_deinterleave utf_view csb_extract.o cpk_unpack.o cpk_uncompress.o usm_deinterleave.o utf_view.o utf_tab.o util.o 
